...
def create_player(life):
    ...
    dictionary
    '''
    player = {"icon": PLAYER_ICON, "position_x": PLAYER_START_X, "position_y": PLAYER_START_Y, "wallet": 5, "lives": life, "current_room": 1, "doorkey": 0, "weapon": 0, "random_id": randint(10000, 99999)}
    return player
